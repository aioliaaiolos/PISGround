...
>> "%~dp0deliverLog.txt" 2>&1 (
	...
	call :DoCopy "%GROUND_TEST_RESULTS_FOLDER%" "%GROUND_TEST_RESULTS_PATH%" || SET EXIT_CODE=21 && goto :End
	call :DoCopy "%T2GVEHICLEINFOSIVENG_FILE%" "%T2GVEHICLEINFOSIVENG_AND_T2GVEHICLEINFOURBAN_PATH%" || SET EXIT_CODE=22 && goto :End
	call :DoCopy "%T2GVEHICLEINFOURBAN_FILE%" "%T2GVEHICLEINFOSIVENG_AND_T2GVEHICLEINFOURBAN_PATH%" || SET EXIT_CODE=23 && goto :End
)
