...
namespace PIS.Ground.MissionControlTests.RemoteDataStoreSimulator
{
	...
	public class RemoteDataStore : RemoteDataStoreProxy
	{
		...
		public RemoteDataStore(string localPackagePath, string version)
		{
